...
SoftwareSerial mySerial(SP2_RX, SP2_TX);
...
void setup() {
  ...
  pinMode(SP2_RX, INPUT);
  pinMode(SP2_TX, OUTPUT);
}
...
//  delay(3000);
  if (Serial.available())
  {
    ...
    if (c == '1')
    {
      mySerial.println("Mess from Arduino");
      Serial.println("Send Mess");
    }
  }
